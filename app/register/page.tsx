...
import { CreditCard, Loader2, CheckCircle, XCircle, Shield, Info, X } from "lucide-react"
                ...
                <div className="space-y-4">
                    ...
                    <div className="space-y-4">
                        {selectedEvents.map(eventId => {
                            ...
                            return (
                                <div key={eventId} className="bg-white/5 backdrop-blur-xl rounded-xl border border-white/10 shadow-lg p-4">
                                    <h5 className="font-medium mb-3 text-cyan-300">
                                        {event?.name}
                                    </h5>
                ...
                <div className="space-y-4">
                    ...
                    <div className="space-y-4">
                        {selectedEvents.map(eventId => {
                            const event = events.find(e => e.id === eventId);
                            const rules = eventRules[eventId];
                            if (!rules?.coordinators) return null;

                            return (
                                <div key={eventId} className="bg-white/5 backdrop-blur-xl rounded-xl border border-white/10 shadow-lg p-4">
                                    <h5 className="font-medium mb-3 text-purple-300">
                                        {event?.name}
                                    </h5>
                                    <div className="space-y-2">
                    ...
                    <SheetContent side="bottom" className="h-[85vh] bg-black/40 backdrop-blur-xl border-cyan-500/40 rounded-t-2xl p-0">
                        <SheetHeader className="space-y-2 px-6 pt-6 pb-4">
                            ...
                            <SheetDescription className="text-cyan-300/80 text-center">
                                Important information for your selected events
                            </SheetDescription>
                        </SheetHeader>
