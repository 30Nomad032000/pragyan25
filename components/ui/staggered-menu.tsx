...
export const StaggeredMenu: React.FC<StaggeredMenuProps> = ({
    ...
    useLayoutEffect(() => {
        const ctx = gsap.context(() => {
            ...
            // Set initial state based on isOpen prop
    ...
    // Effect to respond to isOpen prop changes
    React.useEffect(() => {
        ...
        >
            ...
            >
                ...
                >
                    ...
                    <button
                        className={`sm-toggle relative inline-flex items-center gap-[0.3rem] bg-transparent border-0 cursor-pointer font-medium leading-none overflow-visible pointer-events-auto ${isOpen ? 'text-black' : 'text-[#e9e9ef]'
                            }`}
                        ...
                        type="button"
                    >
                        <span className="sm-toggle-textWrap relative inline-block h-[1em] overflow-hidden whitespace-nowrap w-[var(--sm-toggle-width,auto)] min-w-[var(--sm-toggle-width,auto)]" aria-hidden="true">
                        ...
                        <span className="sm-icon relative w-[14px] h-[14px] shrink-0 inline-flex items-center justify-center [will-change:transform]" aria-hidden="true">
                            <span className="sm-icon-line absolute left-1/2 top-1/2 w-full h-[2px] bg-current rounded-[2px] -translate-x-1/2 -translate-y-1/2 [will-change:transform]" />
                            <span className={`sm-icon-line sm-icon-line-v absolute left-1/2 top-1/2 w-full h-[2px] bg-current rounded-[2px] -translate-x-1/2 -translate-y-1/2 [will-change:transform] ${isOpen ? 'rotate-45' : 'rotate-90'}`} />
                        </span>
                    </button>
                </header>
